<?php
/**
 * MaterializeTemplate.php
 * audiorama
 * Date: 29.04.17
 */

namespace AppBundle\Pagination\Template;


use Pagerfanta\View\Template\Template;

class MaterializeTemplate extends Template
{

    static protected $defaultOptions = array(
        'prev_message'        => '<i class="material-icons">chevron_left</i>',
        'next_message'        => '<i class="material-icons">chevron_right</i>',
        'dots_message'        => '&hellip;',
        'active_suffix'       => '',
        'css_container_class' => 'pagination',
        'css_prev_class'      => 'prev waves-effect',
        'css_next_class'      => 'next waves-effect',
